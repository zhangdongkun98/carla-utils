...
from ..world_map import WalkerWithController
...
class AgentListMaster(ABC):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.walkers: List[WalkerWithController] = []
    ...
    def register_walker(self, walker: WalkerWithController):
    ...
    def destroy(self):
        ...
        if self.silent:
            self.client.apply_batch_sync(batch_vehicle)
        else:
        ...
        for walker in self.walkers:
            batch_walker.extend(walker.destroy_commands())
        self.client.apply_batch_sync(batch_walker)
        self.core.tick()
    ...
    def check_collision(self):
        ...
        for i, agent in enumerate(self.agents):
            ...
            for j, other_agent in enumerate(self.agents + self.obstacles):  # ! warning
