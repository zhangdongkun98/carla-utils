...
class ColorLib(object):
    ...
    COLOR_BLACK = (0, 0, 0)
    COLOR_GREY = (190, 190, 190)


### origin
COLOR_BACKGROUND = ColorLib.COLOR_WHITE
COLOR_PARKING = ColorLib.COLOR_ALUMINIUM_4_5
COLOR_SHOULDER = ColorLib.COLOR_ALUMINIUM_5
COLOR_SIDEWALK = ColorLib.COLOR_ALUMINIUM_3
COLOR_ROAD = ColorLib.COLOR_ALUMINIUM_5
COLOR_ARROW = ColorLib.COLOR_ALUMINIUM_2
...
COLOR_SHOULDER = ColorLib.COLOR_ALUMINIUM_5
COLOR_SIDEWALK = ColorLib.COLOR_ALUMINIUM_3
COLOR_ROAD = ColorLib.COLOR_GREY
COLOR_ARROW = ColorLib.COLOR_WHITE
...
class TownMapImage(object):
    ...
    def draw(self):
        ...
        self.image_cv2[:,:,] = COLOR_BACKGROUND
    ...
    def draw_topology(self):
        ...
        for waypoint in topology:
            ...
            PARKING_COLOR = COLOR_PARKING  ## COLOR_ALUMINIUM_4_5 = pygame.Color(66, 62, 64)
            SHOULDER_COLOR = COLOR_SHOULDER   ## COLOR_ALUMINIUM_5 = pygame.Color(46, 52, 54)
            SIDEWALK_COLOR = COLOR_SIDEWALK   ## COLOR_ALUMINIUM_3 = pygame.Color(136, 138, 133)
        ...
        for waypoints in set_waypoints:
            ...
            if len(polygon) > 2:
                cv2.fillPoly(self.image_cv2, pts=[np.array(polygon, np.int32)], color=COLOR_ROAD)
    ...
    def draw_lane_marking_single_side(self, waypoints, sign):
        ...
        for markings in markings_list:
            if markings[0] == carla.LaneMarkingType.Solid:
                self.draw_solid_line(markings[1], False, markings[2], width=1)
            elif markings[0] == carla.LaneMarkingType.Broken:
                self.draw_broken_line(markings[1], False, markings[2], width=1)
        return

    def draw_arrow(self, transform, color=COLOR_ARROW):
    ...
    def draw_broken_line(self, color, closed, points, width):
        ...
        for line in broken_lines:
            cv2.polylines(self.image_cv2, [np.array(line, np.int32)], closed, COLOR_ARROW, width)
